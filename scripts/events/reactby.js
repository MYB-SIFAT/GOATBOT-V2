...
module.exports = {
    ...
    onStart: async function ({ api, event, threadsData, getLang }) {
        ...
        /* ── Cache every normal message sender ── */
